...
| Model from most and least correlated dimensionless variable| $\mathcal{M}_{8}\left(x_1=\mathcal{I}\left(\dfrac{h}{wa}\right),x_2=\mathcal{I}\left(\dfrac{th}{ll}\right)\right) $</br>$= -1.58x_1-0.0065x_2+\dfrac{93.71x_1}{0.86x_1+26.64+\dfrac{-34.55x_2}{3.43x_2+\dfrac{8.12x_2-8.56}{0.67x_1-41.75}}}$ | $0.8072$ | 3 |
...
| Model based on an index from $BMI_t$ | $\mathcal{M}_{12}\left(x=BMI_T\right) = 53.54-\dfrac{291100.77}{-59.2x+8621.06+\dfrac{-25007576.022x}{-268.21x+19807.81+\dfrac{65200539.26}{-71.70x+848.60}}} $ | $0.8116$ | 6 |
...
| Model from the top two most correlated and independent indices | $\mathcal{M}_{9}\left(x_1=\mathcal{I}\left(\dfrac{h}{wa}\right),x_2=\mathcal{I}\left(\dfrac{ll}{tr}\right)\right) $</br>$=(-2.40x_2 + 143.31) + \dfrac{23.27x_1 - 208.66x_2}{73.80 + \dfrac{-127.74x_2}{-10.64x_1 - 148.25x_2 + \dfrac{105.69x_1}{-12.74}}}$ | $0.867$ | 1 |
